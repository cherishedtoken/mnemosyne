//
//  MNEToDoListTableViewController.m
//  Mnemosyne
//
...
#import "MNEAddToDoItemViewController.h"
...
{
    MNEAddToDoItemViewController *source = [segue sourceViewController];
    MNEToDoItem *item = source.toDoItem;
    if (item != nil) {
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    MNEToDoItem *tappedItem = [self.toDoItems objectAtIndex:indexPath.row];
